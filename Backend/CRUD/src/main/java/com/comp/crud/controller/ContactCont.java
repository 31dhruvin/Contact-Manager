...
//    }
    ...
    public ResponseEntity<String> deletedAllBooks(@RequestBody Contact contact) {
        dataService.deleteAllContacts(contact);
        return new ResponseEntity<String>("deleted succ",HttpStatus.OK);
    }
